...
[@algorandfoundation/algokit-subscriber](../README.md) / subscriber
...
`arc28Events` are any [ARC-28 event definitions](../_media/subscriptions.md#arc-28-events).
